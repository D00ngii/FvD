let hamburgerNavOpen = document.querySelector("header nav");
...
function openMenu() {
  ...
  hamburgerNavOpen.classList.toggle("open");
  hamburgerNavOpen.setAttribute("inert", true);
}

let listNavOpen = document.querySelector("main nav");
let listOpenButton = document.querySelector(
  "main section section:nth-of-type(1) > button"
);
let listCloseButton = document.querySelector(
  "main section section:nth-of-type(1) nav div button"
);

// Tim van Ingen heeft mij hiebij geholpen :)
if (listCloseButton != null) {
  listOpenButton.addEventListener("click", openListMenu);
  listCloseButton.addEventListener("click", openListMenu);
}
function openListMenu() {
  console.log("dit werkt");
  listNavOpen.classList.toggle("openList");
  listNavOpen.setAttribute("inert", true);
}
function createCaroCarrousel(carrouselID) {
  ...
  function scrollToElement(newElement) {
    ...
    let carouselContainer = newElement.closest("section");
    ...
    //change background
    carouselContainer.classList.toggle("alternative");
  }
